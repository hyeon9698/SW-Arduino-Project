...
while True:
    if ser.readable():
        ...
        if val.decode()[:len(val)-2] == '8':
            ...
            img3 = cv2.imread('imgs/3.jpg')
            img4 = cv2.imread('imgs/4.jpg')
            img11 = cv2.imread('imgs/11.jpg')
            img12 = cv2.imread('imgs/12.jpg')
            img13 = cv2.imread('imgs/13.jpg')
            img14 = cv2.imread('imgs/14.jpg')
            img15 = cv2.imread('imgs/15.jpg')
            img16 = cv2.imread('imgs/16.jpg')
            img17 = cv2.imread('imgs/17.jpg')
            img18 = cv2.imread('imgs/18.jpg')
            img19 = cv2.imread('imgs/19.jpg')
            img20 = cv2.imread('imgs/20.jpg')
            img21 = cv2.imread('imgs/21.jpg')
            img22 = cv2.imread('imgs/22.jpg')
            img23 = cv2.imread('imgs/23.jpg')
            img24 = cv2.imread('imgs/24.jpg')
            img25 = cv2.imread('imgs/25.jpg')
            img26 = cv2.imread('imgs/26.jpg')
            img27 = cv2.imread('imgs/27.jpg')
            img28 = cv2.imread('imgs/28.jpg')
            img29 = cv2.imread('imgs/29.jpg')
            img30 = cv2.imread('imgs/30.jpg')
            img31 = cv2.imread('imgs/31.jpg')
            img32 = cv2.imread('imgs/32.jpg')
            img33 = cv2.imread('imgs/33.jpg')
            img34 = cv2.imread('imgs/34.jpg')
            img35 = cv2.imread('imgs/35.jpg')
            img36 = cv2.imread('imgs/36.jpg')
            img37 = cv2.imread('imgs/37.jpg')
            img38 = cv2.imread('imgs/38.jpg')
            img39 = cv2.imread('imgs/39.jpg')
            img40 = cv2.imread('imgs/40.jpg')
            img41 = cv2.imread('imgs/41.jpg')
            img42 = cv2.imread('imgs/42.jpg')
